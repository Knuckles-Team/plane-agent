...
ARG FASTMCP_SERVER_AUTH_JWT_AUDIENCE="plane-mcp"
...
RUN apt-get update \
    ...
    && uv pip install --system --upgrade --verbose --no-cache --break-system-packages --prerelease=allow plane-agent>=0.1.44
